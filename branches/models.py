...
class CoffeeShop(models.Model):
    branch = models.ForeignKey(Branches, on_delete=models.CASCADE, related_name='branches', verbose_name='Филиал')
    menu = models.ForeignKey(Menu, on_delete=models.CASCADE, related_name='menu', verbose_name='Меню')
